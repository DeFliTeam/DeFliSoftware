...
# IMPORT FUNCTIONS
# ///////////////////////////////////////////////////////////////
from application.gui.core.functions import *
...
class PyTitleBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.top_logo_png = QPixmap(Functions.set_png_image(self._logo_image))
        image_label = QLabel()
        self.top_logo_layout.addWidget(image_label, Qt.AlignCenter, Qt.AlignCenter)
        image_label.setPixmap(self.top_logo_png)
